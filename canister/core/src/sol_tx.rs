...
//!
//! Потребители: memo от тресхолд-адреса (M0, доказательство контура подписи) и инструкции
//! эскроу-программы `mark_disputed`/`resolve_dispute` от арбитра (M2) — один сборщик.
