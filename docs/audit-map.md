...
| A3 | **LOW→MED** — дробление доната удваивало очки: `pointsForAmount` round-half-up супераддитивен (`round(0.5)·2 > round(1)`, на любой .5) | закрыто | **floor** (субаддитивно) → дробление не инфлирует; ставка ≤ 1 очко/USDC; детерминизм §4.4 сохранён |
